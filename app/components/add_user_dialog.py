            ...
            rx.el.form(
                ...
                rx.el.div(
                    ...
                    rx.el.input(
                        ...
                        default_value=AuthState.new_user_email,
                        class_name="w-full p-2 mt-1 border border-gray-300 rounded-md focus:ring-indigo-500 focus:border-indigo-500",
                    ),
                    class_name="mb-4",
                ),
                rx.el.div(
                    ...
                    rx.el.input(
                        ...
                        default_value=AuthState.new_user_phone,
                        class_name="w-full p-2 mt-1 border border-gray-300 rounded-md focus:ring-indigo-500 focus:border-indigo-500",
                    ),
                    class_name="mb-4",
                ),
                rx.el.div(
                    ...
                    rx.el.textarea(
                        ...
                        default_value=AuthState.new_user_contact_info,
                ...
                rx.el.div(
                    ...
                    rx.el.div(
                        rx.el.input(
                            ...
                            checked=AuthState.new_user_assign_admin_role,
                    ...
                    rx.el.div(
                        rx.el.input(
                            ...
                            checked=AuthState.new_user_assign_user_role,
                            class_name="mr-2 focus:ring-indigo-500",
                        ),
                        rx.el.label(
                            "Usuario Estándar",
